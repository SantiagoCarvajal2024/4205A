...
void Blue_Right() {
  ...
  delay(400);
  chassis.pid_odom_set(12_in, 110, true); 
  chassis.pid_wait();
  delay(1200);
  chassis.pid_odom_set(-34_in, 127, true), Doinker.set_value(true);
  chassis.pid_wait();
...
void Blue_Left() {
  chassis.odom_xyt_set(0_in, 0_in, -32.7_deg);
  chassis.pid_odom_set(11.4_in, 127, true);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(-135_deg, 127, true);
  chassis.pid_wait();
  chassis.pid_odom_set(-20_in, 90, true);
  chassis.pid_wait();
  Intake_move(12000,0);
  delay(1700);
  Intake_move(0,0);
  chassis.pid_odom_set(51_in, 127, true);
  chassis.pid_wait();
  chassis.pid_turn_set(179_deg, 127, true), Intake_move(12000,0), 
  chassis.pid_wait();
  Doinker.set_value(false);
  delay(800);
  chassis.pid_odom_set(13.4_in, 127, true); 
  chassis.pid_wait();
  delay(1300);
...
void Skill() {
  ...
  delay(4000);
  Intake_move(0,0);
  chassis.pid_odom_set(13_in, 127, true), Recarga.set_value(true);;
  chassis.pid_wait();
  chassis.pid_turn_set(-135_deg, 127, true);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(-180_deg, 127, true);
  chassis.pid_wait();
  chassis.pid_odom_set(-44_in, 127, true);
  chassis.pid_wait();
  chassis.pid_turn_set(135_deg, 127, true);
  chassis.pid_wait();
  ...
  chassis.pid_wait();
  delay(3000);
  chassis.pid_odom_set(-30_in, 127, true), Recarga.set_value(true);
  chassis.pid_wait();
  Intake_move(12000,12000);
  delay(4000);
  chassis.pid_odom_set(13_in, 127, true), Intake_move(0,0);
  chassis.pid_wait();
  chassis.pid_turn_set(90_deg, 127, true);
  chassis.pid_wait();
  chassis.pid_odom_set(96_in, 127, true);
  chassis.pid_wait();
  chassis.pid_turn_set(0_deg, 127, true);
  chassis.pid_wait();
  Recarga.set_value(false);
