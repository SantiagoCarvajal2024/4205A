...
ez::tracking_wheel horiz_tracker(-13, 2.75, 4.0);  // This tracking wheel is perpendicular to the drive wheels
ez::tracking_wheel vert_tracker(-12, 2.75, 4.0);   // This tracking wheel is parallel to the drive wheels
